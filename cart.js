...
//     var title = shopProducts.getElementsByClassName("cart-product-tittle")[0].innerText
//     var price = shopProducts.getElementsByClassName("price2")[0].innerText
...
//     var cartItemsNames = cartItem.getElementsByClassName('cart-product-tittle')
...
function addCartClicked(event) {
    var button = event.target;
    var shopProducts = button.parentElement.parentElement; // Go up two levels to reach the parent of the parent
